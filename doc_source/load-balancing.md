...
In order to tag the network load balancers, you can add the annotation   `service.beta.kubernetes.io/aws-load-balancer-additional-resource-tags` to your network load balancer during or after creation. To learn more, visit [here](https://kubernetes.io/docs/concepts/services-networking/service/#other-elb-annotations).
